...
class IMGParser:
    def __init__(self):
        ...
        self.lower_ylane = np.array([0,80,100])
        self.upper_ylane = np.array([20,255,255])
        self.crop_pts = np.array([[[320/2-10,240/2],[320/2+10,240/2],[320-70,240/2+80],[70,240/2+80]]])
